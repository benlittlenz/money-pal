...
}, _views_App_vue__WEBPACK_IMPORTED_MODULE_3__["default"]));
...
function page(path) {
  return function () {
    return !(function webpackMissingModule() { var e = new Error("Cannot find module 'undefined'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).then(function (m) {
      return m["default"] || m;
    });
  };
}
...
__webpack_require__(/*! /home/ben/Projects/money-pal/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/ben/Projects/money-pal/resources/css/app.css */"./resources/css/app.css");
